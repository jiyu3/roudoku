<table id="law">
	...
	<col width="505">
		...
		<tr>
			<td>住所</td>
			<td>東京都新宿区西早稲田2丁目18番23号</td>
		</tr>
		<tr>
			<td>電話番号</td>
			<td>050-5585-1095（お問い合せは電話ではなく、下記のメールアドレスまでお願いします）</td>
        </tr>
		<tr>
			<td>お問い合わせ先</td>
		...
		<tr>
			...
			<td>本商品は、<a href="http://rodokushojo.jp/site/infos/whatisrodokushojo/" target="_blank">iPhone/iPadアプリ「<?php echo SERVICE_NAME; ?>」</a>のWeb版です。
				上記の料金を支払うことにより、乙葉しおりの朗読をいつでも視聴することができます。
				<a href="<?php echo $this->Html->url("/play", false); ?>">こちら</a>が無料体験版の視聴ができます。</td>
        <tr>
			<td>商品代金以外に必要な費用</td>
			<td>なし</td>
		</tr>
		...
		<tr>
			<td>事業者の責任</td>
			<td>各々のサービスで特に定めない限り、法令によるものとします。</td>
		</tr>
		<tr>
			<td>返品・解約条件</td>
